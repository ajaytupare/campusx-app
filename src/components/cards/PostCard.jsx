...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="bg-[var(--cx-bg-surface)] rounded-[24px] p-5 shadow-sm border border-[var(--cx-text-muted)]/10 hover:shadow-md transition-shadow">
      
      {/* Post Header */}
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-center gap-3">
          <div className={`w-11 h-11 rounded-2xl flex items-center justify-center overflow-hidden shrink-0 border border-[var(--cx-text-muted)]/10
      ...
      {/* Action Buttons */}
      <div className="flex items-center justify-between pt-3 border-t border-[var(--cx-text-muted)]/10">
