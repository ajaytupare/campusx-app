...
const UserProfile = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full max-w-[1050px] mx-auto gap-6 pb-12">
      ...
      {/* Profile Header Card */}
      <div className="bg-white rounded-b-[24px] overflow-hidden shadow-sm border border-zinc-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-6 px-4 lg:px-0">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white rounded-[16px] p-5 shadow-sm border border-zinc-200">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-white rounded-[16px] p-5 shadow-sm border border-zinc-200">
            ...
            {userPosts.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 border-2 border-dashed border-zinc-200 rounded-[12px]">
