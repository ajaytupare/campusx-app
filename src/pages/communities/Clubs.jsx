...
import { Search, Plus, Users, Shield, BookOpen, Activity, ChevronDown } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-2 flex flex-col md:flex-row items-center gap-2 mb-10">
        ...
        <div className="flex-1 flex items-center gap-3 px-4 py-2 w-full border-b md:border-b-0 md:border-r border-gray-100">
          ...
          <div className="flex flex-col w-full">
            ...
            <input type="text" placeholder="Find a club or organization..." className="w-full text-sm outline-none placeholder-gray-400 bg-transparent" />
          </div>
        </div>

        {/* Categories Desktop Scroll */}
        <div className="hidden lg:flex items-center gap-2 px-4 py-2 overflow-x-auto hide-scrollbar">
          {categories.map((cat) => (
            <button 
              key={cat}
        ...
        {/* Category Mobile Dropdown (Simulated) */}
        <div className="lg:hidden flex-1 flex items-center gap-3 px-4 py-2 w-full">
          <div className="flex flex-col w-full">
            <span className="text-[10px] font-bold text-gray-800 uppercase tracking-wider">Category</span>
            <div className="flex items-center justify-between cursor-pointer">
              <span className="text-sm font-medium text-gray-900">{activeCategory}</span>
