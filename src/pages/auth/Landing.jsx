    ...
    <div className="min-h-screen bg-[var(--cx-bg-base)] flex flex-col font-sans overflow-hidden">
      ...
      <nav className="w-full flex justify-between items-center px-4 md:px-12 py-6 max-w-7xl mx-auto relative z-20 gap-4 flex-wrap">
        <div className="flex items-center gap-2 shrink-0">
          ...
          <h1 className="text-xl md:text-2xl font-semibold tracking-tight text-[var(--cx-text-main)] leading-none">CampusX</h1>
        </div>
        <div className="flex items-center gap-3 md:gap-6 shrink-0">
          ...
          <Link to="/register" className="px-4 md:px-5 py-2 md:py-2.5 bg-[var(--cx-text-main)] text-[var(--cx-bg-surface)] font-bold rounded-xl hover:bg-black transition-colors text-[14px] md:text-[15px]">
            Join CampusX
          </Link>
        </div>
      </nav>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center relative z-10 pt-12 pb-24">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--cx-bg-surface)] border border-[var(--cx-text-muted)]/20 shadow-[0_2px_8px_rgba(0,0,0,0.04)] mb-8">
        ...
        <h2 className="text-5xl md:text-7xl font-semibold text-[var(--cx-text-main)] max-w-4xl tracking-tight leading-[1.1] mb-6">
          Your Campus.<br />
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center max-w-md mx-auto">
          <Link to="/register" className="w-full sm:w-auto px-8 py-4 bg-[var(--cx-primary)] text-white font-bold rounded-xl text-lg hover:brightness-110 transition-all shadow-lg flex items-center justify-center gap-2 hover:-translate-y-1">
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full text-left">
          ...
          <div className="bg-[var(--cx-bg-surface)] p-8 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-black/[0.04]">
