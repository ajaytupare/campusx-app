...
const VerifyEmail = () => {
  return (
    <div className="min-h-screen bg-[var(--cx-bg-base)] flex flex-col items-center justify-center p-6 font-sans">
      <div className="w-full max-w-[440px] bg-[var(--cx-bg-surface)] rounded-[32px] p-8 md:p-10 shadow-lg border border-black/[0.04] text-center">
        
        <div className="w-16 h-16 bg-blue-50 rounded-[20px] flex items-center justify-center mx-auto mb-6">
          <Mail className="w-8 h-8 text-blue-500" />
        </div>
        
        <h2 className="text-2xl md:text-3xl font-semibold text-[var(--cx-text-main)] mb-3 tracking-tight">Check your inbox</h2>
        ...
        <Link 
          to="/login"
          className="w-full py-4 rounded-xl font-bold text-[15px] bg-[var(--cx-text-main)] text-white transition-all shadow-md flex items-center justify-center gap-2 hover:bg-black hover:-translate-y-0.5"
        >
