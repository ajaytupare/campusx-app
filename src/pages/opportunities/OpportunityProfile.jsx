        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-[16px] bg-[var(--cx-bg-base)] border border-[var(--cx-text-muted)]/10 flex items-center justify-center text-2xl font-black text-[var(--cx-primary)] shrink-0">
                {opp.company.charAt(0)}
              </div>
              <div>
                <h1 className="text-3xl font-extrabold text-[var(--cx-text-main)] tracking-tight leading-tight">
                  {opp.title}
                </h1>
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              <span className="inline-flex items-center px-4 py-2 rounded-xl bg-[var(--cx-bg-base)] border border-[var(--cx-text-muted)]/10 text-[var(--cx-text-main)] font-bold text-[13px]">
            ...
            <div className="prose prose-zinc dark:prose-invert max-w-none">
              <h3 className="font-extrabold text-[18px] text-[var(--cx-text-main)] mb-3">About the Role</h3>
          ...
          <div className="lg:w-80 shrink-0">
            <div className="bg-[var(--cx-bg-base)] rounded-[24px] p-6 border border-[var(--cx-text-muted)]/10 sticky top-6">
              ...
              <h3 className="font-extrabold text-[16px] text-[var(--cx-text-main)] mb-4">Ready to apply?</h3>
              ...
              {isGhostMode ? (
                ...
                <div className="bg-green-50 border border-green-200 dark:bg-green-900/10 dark:border-green-500/20 rounded-[16px] p-4 flex flex-col items-center justify-center text-center">
                ...
                <button 
                  onClick={handleApply}
                  className="w-full py-4 rounded-[16px] font-extrabold flex items-center justify-center gap-2 text-[15px] bg-[var(--cx-primary)] text-white hover:shadow-lg hover:shadow-indigo-500/30 hover:scale-105 active:scale-95 transition-all"
                >
                  Apply Now
                </button>
              )}
